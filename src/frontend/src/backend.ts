...
export class Backend implements backendInterface {
    ...
    async calculateAndSave(arg0: number, arg1: bigint, arg2: number): Promise<Calculation> {
        if (this.processError) {
            try {
                const result = await this.actor.calculateAndSave(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserCalculations(): Promise<Array<Calculation>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserCalculations();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
